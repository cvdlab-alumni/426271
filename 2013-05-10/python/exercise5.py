...
#Exercise 4
def steering_wheel():
    tor = TORUS([0.8, 1])([40,40]);
    #
    little_circle = T(3)(-0.05)(PROD([circle_full(0.3), Q(0.1)]));
    #
    piece = T([1,3])([-0.1,-0.05])(CUBOID([0.2,0.8,0.1]));
    #
    pieces = STRUCT([piece, R([1,2])(0.66*PI)(piece),R([1,2])(-0.66*PI)(piece)])
    #
    st = COLOR(BLACK)(STRUCT([tor,little_circle,pieces]));
    #
    return st;

steering_wheel = T([1,2,3])([7,4,2.5])(S([1,2,3])([0.3,0.3,0.3])(R([1,2])(PI/2)(R([2,3])(PI/2)(steering_wheel()))));

#VIEW(STRUCT([ex_1,wheels,steering_wheel]));

#Exercise 5
def car_door():
    points1 = [[6.33, 0, 1.77], [7.08, 0, 1.79], [7.79, 0, 1.77], [8.21, 0, 1.81]];
    c1 = BEZIER(S1)(points1);
    curve1 = MAP(c1)(domain);
    #
    points2 = [[6.25, -0.18, 1.53], [6.94, -0.18, 1.53], [7.69, -0.18, 1.53], [8.24, -0.18, 1.54]];
    c2 = BEZIER(S1)(points2);
    curve2 = MAP(c2)(domain);
    #
    points3 = [[6.29, -0.13, 1.70], [6.99, -0.13, 1.70], [7.58, -0.13, 1.70], [8.23, -0.13, 1.70]];
    c3 = BEZIER(S1)(points3);
    curve3 = MAP(c3)(domain);
    #
    points4 = [[6.29, -0.16, 0.92], [6.96, -0.16, 0.93], [7.52, -0.16, 0.93], [8.12, -0.16, 0.95]];
    c4 = BEZIER(S1)(points4);
    curve4 = MAP(c4)(domain);
    #
    cd_1 = MAP(BEZIER(S2)([c1, c3, c2]))(domain2D);
    #
    cd_2 = MAP(BEZIER(S2)([c2,c4]))(domain2D);
    #
    curves = COLOR(RED)(STRUCT([cd_1,cd_2]));
    return curves;

car_door = car_door();

def motor_cover():
    points1 = [[4.24, 0, 1.53], [4.33, 0, 1.68], [5.57, 0, 1.74], [6.34, 0, 1.77]];
    c1 = BEZIER(S1)(points1);
    curve1 = MAP(c1)(domain);
    #
    points2 = [[4, 1.1, 1.59], [4.58, 1.1, 1.8], [5.23, 1.1, 1.81], [6, 1.1, 1.84]];
    c2 = BEZIER(S1)(points2);
    curve2 = MAP(c2)(domain);
    #
    points3 = [[4.24, 2.2, 1.53], [4.33, 2.2, 1.68], [5.57, 2.2, 1.74], [6.34, 2.2, 1.77]];
    c3 = BEZIER(S1)(points3);
    curve3 = MAP(c3)(domain);
    #
    points4 = [[4.24, 1.6, 1.53], [6.34, 1.8, 1.77]];
    c4 = BEZIER(S1)(points4);
    curve4 = MAP(c4)(domain);
    #
    points5 = [[4, 1.4, 1.65], [6.1, 1.6, 1.90]];
    c5 = BEZIER(S1)(points5);
    curve5 = MAP(c5)(domain);
    #
    points6 = [[4, 0.8, 1.65], [6.1, 0.6, 1.90]];
    c6 = BEZIER(S1)(points6);
    curve6 = MAP(c6)(domain);
    #
    points7 = [[4.24, 0.6, 1.53], [6.34, 0.4, 1.77]];
    c7 = BEZIER(S1)(points7);
    curve7 = MAP(c7)(domain);
    #
    cof_1 = MAP(BEZIER(S2)([c1,c7]))(domain2D);
    #
    cof_2 = MAP(BEZIER(S2)([c7,c6]))(domain2D);
    #
    cof_3 = MAP(BEZIER(S2)([c6,c2,c5]))(domain2D);
    #
    cof_4 = MAP(BEZIER(S2)([c5,c4]))(domain2D);
    #
    cof_5 = MAP(BEZIER(S2)([c4,c3]))(domain2D);
    #
    curves = COLOR(RED)(STRUCT([cof_1,cof_2,cof_3,cof_4,cof_5]));
    return curves;

motor_cover = motor_cover();

ex_5 = T([1,2,3])([0.5,3.3,0.5])(STRUCT([car_door, motor_cover]));

VIEW(STRUCT([ex_1,wheels,steering_wheel,ex_5]));